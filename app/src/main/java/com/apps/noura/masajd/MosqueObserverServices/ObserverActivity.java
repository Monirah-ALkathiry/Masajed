package com.apps.noura.masajd.MosqueObserverServices;
...
public class ObserverActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_observer);
        ...
        View contentView = inflater.inflate(R.layout.activity_observer, null, false);
