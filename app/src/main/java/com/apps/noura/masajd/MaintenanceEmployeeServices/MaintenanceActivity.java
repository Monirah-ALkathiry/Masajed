package com.apps.noura.masajd.MaintenanceEmployeeServices;
...
public class MaintenanceActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_maintenance);
        ...
        View contentView = inflater.inflate(R.layout.activity_maintenance, null, false);
